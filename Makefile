...
#    Updated: 2015/04/23 16:26:08 by neprocur         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC	=	ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
		...
		ft_lstadd.c ft_lstdel.c ft_lstdelone.c ft_lstnew.c ft_lstmap.c \
		ft_lstiter.c ft_memalloc.c ft_memccpy.c ft_memchr.c ft_memcmp.c \
		ft_memcpy.c ft_memdel.c ft_memmove.c ft_memset.c ft_poney.c \
		...
		ft_toupper.c ft_strsplit.c ft_islower.c ft_isupper.c
